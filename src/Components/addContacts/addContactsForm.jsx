...
const AddContactsForm = ({handleUpdate}) => {
    ...
    const validateForm=()=>{
        if(firstName =="" || lastName==""|| address ==""|| city ==""|| email=="" || postcode==""){
...
return (
    <Form className="addContacts-form" onSubmit={handleSubmit}>
        <FormGroup row>
            <Label for="firstName" sm={1}>First Name</Label>
            <Col sm={10}>
        ...
        <br />
        <FormGroup row>
            <Label for="lastName" sm={1}>Last Name</Label>
            <Col sm={10}>
        ...
        <FormGroup row>
            ...
            <Col sm={10}>
                <Input type="text" name="city" id="city" placeholder="Enter City"value={city} onChange={(e) => setCity(e.target.value)}/>
            </Col>
        </FormGroup>
        <br />
        <FormGroup row>
            <Label for="postcode" sm={1}>Postcode</Label>
            <Col sm={10}>
                <Input type="text" name="postcode" id="postcode" placeholder="Enter Postcode"value={postcode} onChange={(e) => setPostcode(e.target.value)}/>
            </Col>
        </FormGroup>
        <br />
        <FormGroup row>
